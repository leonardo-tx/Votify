...
public class EmailConfirmationServiceTest {
    ...
    public void setupBeforeEach() {
        ...
        existingAccount = User.parseUnsafe(
                2L,
                Email.parseUnsafe("jhonny@nightcity.2077"),
                UserName.parseUnsafe("silverhand"),
                Name.parseUnsafe("Jhonny Silverhand"),
    ...
    @Test
    public void deleteEmailConfirmation() {
    ...
    @Test
    public void addEmailConfirmationWhenNewAccount() throws VotifyException {
    ...
    @Test
    public void addEmailConfirmationWhenExistingAccount() throws VotifyException {
        when(userProperties.getEmailConfirmationExpirationMinutes()).thenReturn(1);
        when(emailConfirmationRepository.save(any(EmailConfirmation.class)))
                .thenAnswer(i -> i.getArguments()[0]);
