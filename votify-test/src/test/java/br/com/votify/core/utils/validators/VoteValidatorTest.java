...
public class VoteValidatorTest {
    ...
    public void testValidVote() {
        ...
        poll.setVoteOptions(List.of(
                new VoteOption(null, "Option 1", poll),
                new VoteOption(null, "Option 2", poll),
                new VoteOption(null, "Option 3", poll),
                new VoteOption(null, "Option 4", poll),
                new VoteOption(null, "Option 5", poll)
        ));
