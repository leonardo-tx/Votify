...
class PollValidatorTest {
    ...
    void shouldThrowExceptionWhenStartDateIsAfterEndDate() {
        ...
        poll.setVoteOptions(List.of(new VoteOption(null, "teste 1", poll)));
    ...
    void shouldThrowExceptionWhenChoiceLimitExceedsVoteOptions() {
        Poll poll = createValidPoll();
        poll.setVoteOptions(List.of(new VoteOption(null, "teste", poll)));
    ...
    void validateVoteOptions_shouldNotThrowException_whenVoteOptionsAreValid() {
        Poll poll = new Poll();
        List<VoteOption> voteOptions = Arrays.asList(new VoteOption(null, "vote option 1", poll), new VoteOption(null, "vote option 2", poll));
