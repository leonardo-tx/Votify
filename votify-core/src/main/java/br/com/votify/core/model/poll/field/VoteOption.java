...
public final class VoteOption {
    ...
    public VoteOption(VoteOptionRegister voteOptionRegister, Poll poll, int sequence) throws VotifyException {
        ...
        if (poll == null || poll.getId() == null) {
            throw new IllegalArgumentException("The poll or it's id must not be null.");
        }
        ...
        this.name = voteOptionRegister.getName().getValue();
        this.count = 0;
        this.sequence = sequence;
        this.pollId = poll.getId();
    }

    private VoteOption(String name, int count, int sequence, Long pollId) {
        this.name = name;
        this.count = count;
        this.sequence = sequence;
        this.pollId = pollId;
    ...
    public static VoteOption parseUnsafe(String name, int count, int sequence, Long pollId) {
