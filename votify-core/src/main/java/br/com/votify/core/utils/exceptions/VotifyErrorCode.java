...
public enum VotifyErrorCode {
    ...
    EMAIL_CONFIRMATION_ALREAY_SENT("email.confirmation.already.sent", HttpStatus.BAD_REQUEST),
    EMAIL_CONFIRMATION_CODE_EXPIRED("email.confirmation.expired", HttpStatus.BAD_REQUEST),
