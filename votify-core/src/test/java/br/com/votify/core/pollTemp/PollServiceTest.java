...
class PollServiceTest {
    ...
    void shouldReturnPollWithUserVote() {
        ...
        PollResponseDto result = pollService.findSpecificPoll(1L, 100L);
    ...
    void shouldReturnNoVoteWhenUserDidNotVote() {
        ...
        PollResponseDto result = pollService.findSpecificPoll(1L, 200L);
    ...
    void shouldReturnNoVoteForNullUser() {
        ...
        PollResponseDto result = pollService.findSpecificPoll(1L, null);
