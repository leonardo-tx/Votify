...
VALUES (1, 'Melhor Linguagem de Programação', 'Qual você considera a melhor linguagem de programação?', FALSE, 1, CURRENT_TIMESTAMP(), DATEADD('DAY', 7, CURRENT_TIMESTAMP()), 1);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (2, 'Melhor Framework Web', 'Qual o melhor framework para desenvolvimento web?', TRUE, 1, CURRENT_TIMESTAMP(), DATEADD('DAY', 7, CURRENT_TIMESTAMP()), 1);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (3, 'Metodologia Ágil Favorita', 'Qual sua metodologia ágil preferida?', FALSE, 1, CURRENT_TIMESTAMP(), DATEADD('DAY', 7, CURRENT_TIMESTAMP()), 2);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (4, 'Selecione seus jogos favoritos', 'Apenas o dessa lista, claro!' || CHAR(10) || 'Não dá pra colocar mais que 5 opções :P' || CHAR(10) || CHAR(10) || '(Por favor devs, coloquem mais ;-;)', FALSE, 5, CURRENT_TIMESTAMP(), DATEADD('DAY', 14, CURRENT_TIMESTAMP()), 4);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (5, 'Qual seu refrigerante favorito?', 'É pro meu TCC...' || CHAR(10) || CHAR(10) || '🥹👉👈', TRUE, 1, CURRENT_TIMESTAMP(), DATEADD('MONTH', 1, CURRENT_TIMESTAMP()), 7);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (6, 'FAVORITE BAND!', 'I''m a big fan of these bands, I want to know which ones you guys like the most :D', FALSE, 1, DATEADD('DAY', -6, CURRENT_TIMESTAMP()), DATEADD('DAY', 1, CURRENT_TIMESTAMP()), 5);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (7, 'タイトル: 推しアニメは？教えてください！', '数ある名作アニメの中から、あなたが"最高！"と思う作品を教えてください。', FALSE, 1, DATEADD('DAY', -4, CURRENT_TIMESTAMP()), DATEADD('HOUR', 12, CURRENT_TIMESTAMP()), 16);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (8, 'Pizza com abacaxi...', '', FALSE, 1, DATEADD('DAY', -1, CURRENT_TIMESTAMP()), DATEADD('MINUTE', 30, CURRENT_TIMESTAMP()), 3);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (9, 'Qual sua rede social favorita?', 'Vamos descobrir qual rede social vai dominar!', TRUE, 1, DATEADD('MONTH', -3, CURRENT_TIMESTAMP()), DATEADD('MONTH', -2, CURRENT_TIMESTAMP()), 12);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (10, 'Qual o seu principal sistema operacional?', '', FALSE, 1, DATEADD('MINUTE', 5, CURRENT_TIMESTAMP()), DATEADD('MONTH', 2, CURRENT_TIMESTAMP()), 12);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (11, 'Sino ang pinakagusto mong karakter sa Until Then?', 'Mahal ko ang larong ito! 💜', FALSE, 1, DATEADD('DAY', -2, CURRENT_TIMESTAMP()), DATEADD('DAY', 1, CURRENT_TIMESTAMP()), 30);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (12, '你最喜欢《凸变英雄X》里的哪个英雄？', '', FALSE, 1, CURRENT_TIMESTAMP(), DATEADD('DAY', 14, CURRENT_TIMESTAMP()), 42);
...
INSERT INTO TB_POLL (id, title, description, user_registration, choice_limit_per_user, start_date, end_date, responsible_id)
VALUES (13, '¿Cuál es el mejor juego multijugador?', 'Seleccione hasta 3 opciones', FALSE, 3, CURRENT_TIMESTAMP(), DATEADD('DAY', 3, CURRENT_TIMESTAMP()), 9);
...
SET count = (
    ...
    AND TB_VOTE.option_value = POWER(2, TB_VOTE_OPTION.sequence)
);